...
//   <div
//     className={cn(
//       "bg-card rounded-xl border p-6 hover:shadow-md transition-all duration-200 hover:-translate-y-1 animate-fade-in relative overflow-hidden",
//       type === "savings" &&
//         "border-green-200 bg-gradient-to-br from-green-50 to-emerald-50",
//       type === "trend" &&
//         "border-amber-200 bg-gradient-to-br from-amber-50 to-orange-50",
...
//   <div
//     className={cn(
//       "bg-card rounded-xl border p-6 hover:shadow-md transition-all duration-200 hover:-translate-y-1 animate-fade-in group cursor-pointer",
//       priority === "high" && "border-l-4 border-l-red-400",
//       priority === "medium" && "border-l-4 border-l-amber-400",
//       priority === "low" && "border-l-4 border-l-primary"
//     )}
...
//         <Clock className="w-3 h-3 text-muted-foreground" />
//         <span className="text-muted-foreground font-medium">Effort: {effort}</span>
//       </div>
//       <div className="flex items-center gap-2 bg-blue-50 px-3 py-1 rounded-lg">
//         <TrendingUp className="w-3 h-3 text-blue-600" />
//         <span className="text-blue-600 font-medium">Impact: {impact}</span>
//       </div>
//     </div>
//   </div>
// );

// const ReportMetric = ({ label, value, change, icon }) => (
//   <div className="text-center animate-fade-in bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors">
//     <div className="flex justify-center mb-2">
//       {icon}
//     </div>
//     <p className="text-sm text-muted-foreground mb-2 font-medium">{label}</p>
//     <p className="text-2xl font-semibold text-foreground font-mono mb-1">
//       {value}
//     </p>
//     <p className="text-xs text-muted-foreground">{change}</p>
//   </div>
...
//     title: "Optimize AC Temperature",
//     description:
//       "Increasing your AC temperature from 22°C to 24°C can reduce consumption by 20-30%. This simple adjustment can significantly impact your monthly bill.",
//     savings: "Save ₹300/month",
//     effort: "Easy",
//     impact: "High",
//   },
...
//     title: "Upgrade Your Refrigerator",
//     description:
//       "Your 8-year-old 3-star fridge consumes 40% more energy than a new 5-star model. Consider upgrading for long-term savings.",
//     savings: "Save ₹150/month",
//     effort: "One-time investment",
//     impact: "Long-term",
//   },
...
//     title: "Switch to LED Lighting",
//     description:
//       "Replace remaining CFL/incandescent bulbs with LED for better efficiency and longer lifespan with reduced heat generation.",
//     savings: "Save ₹80/month",
//     effort: "Easy",
//     impact: "Medium",
//   },
...
//     title: "Install Smart Power Strips",
//     description:
//       "Prevent phantom power consumption from devices in standby mode with automated power management solutions.",
//     savings: "Save ₹120/month",
//     effort: "Moderate",
//     impact: "Medium",
//   },
...
//     priority: "high",
//     title: "Use Timer for Water Heater",
//     description: "Set automated schedules to heat water only when needed, avoiding unnecessary energy waste during off-peak hours.",
//     savings: "Save ₹200/month",
//     effort: "Easy",
//     impact: "High",
//   },
...
//     title: "Upgrade to Inverter AC",
//     description:
//       "Replace conventional AC with inverter technology for 30% better efficiency and consistent temperature control.",
//     savings: "Save ₹400/month",
//     effort: "High investment",
//     impact: "Long-term",
//   },
...
//                 </h2>
//                 <p className="text-muted-foreground">
//                   Tailored suggestions to optimize your energy usage
//                 </p>
//               </div>
//             </div>
//             <div className="text-sm text-muted-foreground bg-blue-50 px-4 py-2 rounded-lg">
//               Showing {getCurrentRecommendations().length} of{" "}
//               {allRecommendations.length} recommendations
//             </div>
//           </div>
...
//                 </h3>
//                 <p className="text-muted-foreground">
//                   Comprehensive overview of your energy consumption
//                 </p>
//               </div>
//             </div>
